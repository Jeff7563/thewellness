...
<div class="card-container">
    <!-- การ์ดกิจกรรม -->
    <div class="card">
        <img src="../images/บอร์ดเกม.jpg" alt="รูปกิจกรรม">
        <div class="card-content">
            <!-- ข้อมูลกิจกรรม -->
            <div class="info-row">
                <i class="fa fa-calendar"></i>
                <span>วันที่: 02 พ.ย. 2567</span>
            </div>
            <div class="info-row">
                <i class="fa fa-clock"></i>
                <span>เวลา: 14:00 - 15:00 น.</span>
            </div>
            <div class="info-row">
            ...
            <div class="activity-details">
                ...
                รายละเอียด: ร่วมผจญภัยไปกับบอร์ดเกมสุดคลาสสิกที่จำลองการสร้างเส้นทางรถไฟ พร้อมพัฒนาทักษะวางแผนและสร้างมิตรภาพใหม่ๆ! กิจกรรมนี้ออกแบบมาเพื่อผู้สูงอายุโดยเฉพาะ เน้นการเล่นแบบสนุกสนานและช่วยกระตุ้นสมอง โดยผู้เล่นจะต้องวางแผนสร้างเส้นทางรถไฟให้เชื่อมโยงเมืองต่างๆ เพื่อสะสมคะแนนและคว้าชัยชนะ
            </div>
            <!-- ปุ่มลงทะเบียน -->
            <form method="POST" action="./sql_registration&courses.php">
                ...
                <input type="hidden" name="course_name" value="<?php echo isset($_SESSION['course_name']) ? $_SESSION['course_name'] : 'บอร์ดเกมรถไฟ'; ?>">
                <div class="centerbb">
                ...
                <?php
                    ...
                    if (!isset($_SESSION['course_name'])) {
                        $_SESSION['course_name'] = 'บอร์ดเกมรถไฟ'; // กำหนดค่าเริ่มต้น
                    }
                ?>
            </form>
        </div>
